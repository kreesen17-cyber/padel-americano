  ...
  // ==========================================
    ...
    // 🔄 FALLS BACK TO YOUR ORIGINAL AMERICANO BELOW:
      ...
      if (playerCount === 4) {
        ...
        // PERFECT AMERICANO COMBINATORIAL MATRICES
        // 12 Players: Every player partners everyone exactly 1x, opposes everyone exactly 2x.
        // 16 Players: Balanced Whist-Sainte-Beuve configuration preventing opponent clustering.
        const unifiedSchedules: Record<number, number[][][]> = {
          12: [
            // Round 1
            [[5, 4], [3, 8]],   [[7, 11], [0, 2]],  [[1, 10], [9, 6]],
            // Round 2
            [[6, 5], [4, 9]],   [[8, 1], [0, 3]],   [[2, 11], [10, 7]],
            // Round 3
            [[7, 6], [5, 10]],  [[9, 2], [0, 4]],   [[3, 1], [11, 8]],
            // Round 4
            [[8, 7], [6, 11]],  [[10, 3], [0, 5]],  [[4, 2], [1, 9]],
            // Round 5
            [[9, 8], [7, 1]],   [[11, 4], [0, 6]],  [[5, 3], [2, 10]],
            // Round 6
            [[10, 9], [8, 2]],  [[1, 5], [0, 7]],   [[6, 4], [3, 11]],
            // Round 7
            [[11, 10], [9, 3]], [[2, 6], [0, 8]],   [[7, 5], [4, 1]],
            // Round 8
            [[1, 11], [10, 4]], [[3, 7], [0, 9]],   [[8, 6], [5, 2]],
            // Round 9
            [[2, 1], [11, 5]],  [[4, 8], [0, 10]],  [[9, 7], [6, 3]],
            // Round 10
            [[3, 2], [1, 6]],   [[5, 9], [0, 11]],  [[10, 8], [7, 4]],
            // Round 11
            [[4, 3], [2, 7]],   [[6, 10], [0, 1]],  [[11, 9], [8, 5]]
          ],
          16: [
