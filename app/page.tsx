...
export default function PadelAmericano() {
  ...
  const startTournament = () => {
    ...
    if (tournamentFormat === 'Mexicano') {
      ...
      if (playerCount === 4) {
        ...
        // Balanced Whist-12: 11 rounds. Every partner 1x, every opponent exactly 2x.
        const m12: MatrixCoords = [
          [[0, 1], [2, 7]],  [[3, 11], [4, 10]], [[5, 9], [6, 8]],   // R1
          [[0, 2], [3, 8]],  [[4, 1],  [5, 11]], [[6, 10], [7, 9]],  // R2
          [[0, 3], [4, 9]],  [[5, 2],  [6, 1]],  [[7, 11], [8, 10]], // R3
          [[0, 4], [5, 10]], [[6, 3],  [7, 2]],  [[8, 1],  [9, 11]], // R4
          [[0, 5], [6, 11]], [[7, 4],  [8, 3]],  [[9, 2],  [10, 1]], // R5
          [[0, 6], [7, 1]],  [[8, 5],  [9, 4]],  [[10, 3], [11, 2]], // R6
          [[0, 7], [8, 2]],  [[9, 6],  [10, 5]], [[11, 4], [1, 3]],  // R7
          [[0, 8], [9, 3]],  [[10, 7], [11, 6]], [[1, 5],  [2, 4]],  // R8
          [[0, 9], [10, 4]], [[11, 8], [1, 7]],  [[2, 6],  [3, 5]],  // R9
          [[0, 10], [11, 5]],[[1, 9],  [2, 8]],  [[3, 7],  [4, 6]],  // R10
          [[0, 11], [1, 6]],  [[2, 10], [3, 9]],  [[4, 8],  [5, 7]]   // R11
        ];
        for (let r = 1; r <= 11; r++) {
        ...
        // Balanced Whist-16: 15 rounds. Every partner 1x, every opponent exactly 2x.
        const m16: MatrixCoords = [
          [[0, 1], [2, 3]],   [[4, 7], [8, 12]],  [[5, 10], [11, 14]], [[6, 13], [9, 15]], // R1
          [[0, 2], [1, 4]],   [[3, 5], [9, 13]],  [[6, 11], [12, 15]], [[7, 14], [8, 10]], // R2
          [[0, 3], [2, 5]],   [[1, 6], [10, 14]], [[4, 12], [13, 1]],  [[7, 8], [9, 11]],  // R3
          [[0, 4], [3, 6]],   [[2, 7], [11, 15]], [[1, 13], [14, 2]],  [[5, 9], [8, 12]],  // R4
          [[0, 5], [4, 11]],  [[1, 12], [6, 10]], [[2, 15], [7, 13]],  [[3, 8], [14, 9]],  // R5
          [[0, 6], [5, 12]],  [[2, 13], [7, 11]], [[3, 1], [4, 9]],    [[14, 10], [15, 8]],// R6
          [[0, 7], [6, 14]],  [[3, 15], [1, 8]],  [[4, 2], [5, 10]],   [[11, 9], [12, 13]],// R7
          [[0, 8], [1, 9]],   [[2, 10], [3, 11]], [[4, 14], [5, 15]],  [[6, 12], [7, 13]], // R8
          [[0, 9], [5, 1]],   [[6, 2],  [7, 3]],  [[8, 13], [11, 4]],  [[12, 10], [15, 14]],// R9
          [[0, 10], [6, 15]], [[7, 1],  [4, 3]],  [[9, 14], [12, 5]],  [[13, 11], [8, 2]], // R10
          [[0, 11], [7, 2]],  [[5, 3],  [1, 10]], [[8, 15], [13, 6]],  [[14, 12], [9, 4]], // R11
          [[0, 12], [3, 14]], [[1, 11], [2, 9]],  [[4, 15], [6, 8]],   [[10, 13], [5, 7]], // R12
          [[0, 13], [4, 15]], [[1, 14], [2, 11]], [[3, 10], [7, 9]],   [[5, 6], [12, 8]],  // R13
          [[0, 14], [2, 12]], [[1, 15], [3, 13]], [[4, 10], [6, 9]],   [[7, 5], [11, 8]],  // R14
          [[0, 15], [3, 12]], [[1, 2],  [4, 6]],  [[5, 13], [7, 10]],  [[9, 8], [14, 11]]  // R15
        ];
        for (let r = 1; r <= 15; r++) {
  ...
  const generateRound = (currentRound: number, currentLeaderboard?: PlayerStats[]) => {
    ...
    if (tournamentFormat === 'Mexicano') {
      ...
      // For Americano tracks, seamlessly pull the round fixtures from precomputed arrays
